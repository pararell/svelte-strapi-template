...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-60b2d791.js",
      css: [assets + "/_app/assets/start-464e9d0a.css", assets + "/_app/assets/vendor-15e614f1.css"],
      js: [assets + "/_app/start-60b2d791.js", assets + "/_app/chunks/vendor-ecfff0c6.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var css$7 = {
  code: ".nav.svelte-fnvt2m.svelte-fnvt2m{background:var(--primary-color);box-shadow:-1px 1px 1px 0 #0000001a;height:50px;width:100%}.nav.svelte-fnvt2m.svelte-fnvt2m,.nav-content.svelte-fnvt2m.svelte-fnvt2m{align-items:center;display:flex}.nav-content.svelte-fnvt2m.svelte-fnvt2m{justify-content:space-between}.nav-list.svelte-fnvt2m.svelte-fnvt2m{align-items:center;display:flex}.nav-li.svelte-fnvt2m.svelte-fnvt2m{list-style:none}.nav-li.active.svelte-fnvt2m .nav-link.svelte-fnvt2m,.nav-li.active.svelte-fnvt2m .sidebar-link.svelte-fnvt2m{font-weight:700}.nav-link.svelte-fnvt2m.svelte-fnvt2m{color:#000;font-size:.875rem;line-height:1.25rem;text-decoration:none}.nav-logo.svelte-fnvt2m.svelte-fnvt2m{font-size:1.2rem}.nav-logo-img.svelte-fnvt2m.svelte-fnvt2m{max-height:40px;max-width:100%}.desktop.svelte-fnvt2m.svelte-fnvt2m{display:none}.mobile.svelte-fnvt2m.svelte-fnvt2m{display:block}@media(min-width:768px){.desktop.svelte-fnvt2m.svelte-fnvt2m{display:block}.mobile.svelte-fnvt2m.svelte-fnvt2m{display:none}}.sidebar.svelte-fnvt2m.svelte-fnvt2m{background:var(--primary-color);border-top:1px solid rgba(0,0,0,.1);box-shadow:-2px 1px 1px rgba(0,0,0,.1);height:calc(100vh - 51px);max-height:100%;min-width:300px;overflow-y:auto;position:fixed;right:0;top:50px;z-index:1}.sidebar-header.svelte-fnvt2m.svelte-fnvt2m{cursor:pointer;padding:15px 15px 0}.sidebar-content.svelte-fnvt2m.svelte-fnvt2m{padding:15px}",
  map: `{"version":3,"file":"Header.svelte","sources":["Header.svelte"],"sourcesContent":["<script>\\n\\timport { page } from '$app/stores';\\n\\timport { createEventDispatcher } from 'svelte';\\n\\timport { DropdownShell, Dropdown, Accordion, AccordionSection } from 'attractions';\\n\\timport { ChevronDownIcon, XIcon } from 'svelte-feather-icons';\\n\\timport { fly} from \\"svelte/transition\\";\\n\\timport { sineIn } from \\"svelte/easing\\";\\n\\timport { API_URL } from '../constants';\\n\\texport let user;\\n\\texport let sidebarOpen = false;\\n\\texport let pages = [];\\n\\texport let categories = [];\\n\\t$: home = pages.find((p) => p.slug === 'home') || { title: 'home' };\\n\\t$: pagesInMenu = pages\\n\\t\\t.filter((p) => p.slug !== 'home' && !p.categories.length)\\n\\t\\t.sort((a, b) => a.position - b.position);\\n\\n\\tconst dispatch = createEventDispatcher();\\n\\n\\tconst handleLogout = () => {\\n\\t\\tdispatch('logout');\\n\\t};\\n\\n\\tconst togleSidebar = () => {\\n\\t\\tdispatch('togglesidebar');\\n\\t};\\n<\/script>\\n\\n<nav class=\\"nav\\">\\n\\t<div class=\\"container\\">\\n\\t\\t<div class=\\"nav-content\\">\\n\\t\\t\\t{#if home?.image && home.image.length}\\n\\t\\t\\t\\t<a class=\\"nav-link nav-logo font-semibold\\" href=\\"/\\">\\n\\t\\t\\t\\t\\t<img class=\\"nav-logo-img\\" src={API_URL + home.image[0].url} alt={home.title} />\\n\\t\\t\\t\\t</a>\\n\\t\\t\\t{:else}\\n\\t\\t\\t\\t<a class=\\"nav-link nav-logo font-semibold\\" href=\\"/\\">{home.title}</a>\\n\\t\\t\\t{/if}\\n\\t\\t\\t<ul class=\\"nav-list\\">\\n\\t\\t\\t\\t{#if pages.length}\\n\\t\\t\\t\\t\\t{#each pagesInMenu as dPage}\\n\\t\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4 desktop\\" class:active={$page.path === '/' + dPage.url}>\\n\\t\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/{dPage.url}\\">{dPage.title}</a>\\n\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if !user}\\n\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/auth/register'}>\\n\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/auth/register\\">Register</a>\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/auth/login'}>\\n\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/auth/login\\">Login</a>\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if user}\\n\\t\\t\\t\\t\\t<li class=\\"nav-li\\"><a class=\\"nav-link\\" href=\\"/\\" on:click={handleLogout}>Logout</a></li>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if pages.length}\\n\\t\\t\\t\\t\\t<li class=\\"nav-li mobile\\">\\n\\t\\t\\t\\t\\t\\t<DropdownShell let:toggle>\\n\\t\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"nav-link mr-4  ml-4 cursor-pointer flex items-center mt-0.5\\"\\n\\t\\t\\t\\t\\t\\t\\t\\ton:click={toggle}\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\tMenu <ChevronDownIcon size=\\"1x\\" class=\\"ml dropdown-chevron\\" />\\n\\t\\t\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t\\t\\t\\t<Dropdown right>\\n\\t\\t\\t\\t\\t\\t\\t\\t<ul class=\\"px-4 py-2\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{#each pagesInMenu as dPage}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/' + dPage.url}>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/{dPage.url}\\">{dPage.title}</a>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t\\t\\t\\t</ul>\\n\\t\\t\\t\\t\\t\\t\\t</Dropdown>\\n\\t\\t\\t\\t\\t\\t</DropdownShell>\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t<li class=\\"px-4 max-h-6\\">\\n\\t\\t\\t\\t\\t<button on:click={togleSidebar}>\\n\\t\\t\\t\\t\\t\\t<svg\\n\\t\\t\\t\\t\\t\\t\\tfill=\\"#000000\\"\\n\\t\\t\\t\\t\\t\\t\\txmlns=\\"http://www.w3.org/2000/svg\\"\\n\\t\\t\\t\\t\\t\\t\\tviewBox=\\"0 0 24 24\\"\\n\\t\\t\\t\\t\\t\\t\\twidth=\\"24px\\"\\n\\t\\t\\t\\t\\t\\t\\theight=\\"24px\\"\\n\\t\\t\\t\\t\\t\\t\\t><path\\n\\t\\t\\t\\t\\t\\t\\t\\td=\\"M 2 5 L 2 7 L 22 7 L 22 5 L 2 5 z M 2 11 L 2 13 L 22 13 L 22 11 L 2 11 z M 2 17 L 2 19 L 22 19 L 22 17 L 2 17 z\\"\\n\\t\\t\\t\\t\\t\\t\\t/></svg\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t</li>\\n\\t\\t\\t</ul>\\n\\t\\t</div>\\n\\t</div>\\n</nav>\\n{#if sidebarOpen}\\n\\t<div class=\\"flex flex-col sidebar\\" transition:fly={{x: 300, duration: 300, opacity: 1, easing: sineIn}}>\\n\\t\\t<div class=\\"sidebar-header\\">\\n\\t\\t\\t<button class=\\"text-2xl\\" on:click={togleSidebar}>\\n\\t\\t\\t\\t<XIcon size=\\"1x\\" class=\\"text-gray-400\\" />\\n\\t\\t\\t</button>\\n\\t\\t</div>\\n\\n\\t\\t<div class=\\"sidebar-content\\">\\n\\t\\t\\t{#if categories.length}\\n\\t\\t\\t\\t<Accordion let:closeOtherPanels>\\n\\t\\t\\t\\t\\t{#each categories as category}\\n\\t\\t\\t\\t\\t\\t<div class=\\"mb-4\\">\\n\\t\\t\\t\\t\\t\\t\\t<AccordionSection on:panel-open={closeOtherPanels} let:toggle>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div slot=\\"handle\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{#if category.pages.length}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<button\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"nav-link mx-auto cursor-pointer flex items-center mt-0.5\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ton:click={toggle}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<h3 class=\\"text-2xl\\">{category.Title}</h3>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<ChevronDownIcon size=\\"2x\\" class=\\"ml accordion-chevron\\" />\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</button>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t{#if category.pages.length}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"px-4 py-1\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{#each category.pages as cPage}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<li class=\\"nav-li flex items-center my-1\\" class:active={$page.path === '/' + cPage.url}>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<a\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"sidebar-link text-base mx-auto\\"\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\ton:click={togleSidebar}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\thref=\\"/{cPage.url}\\">{cPage.title}</a\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t\\t</AccordionSection>\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t</Accordion>\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\t</div>\\n{/if}\\n\\n<style lang=\\"scss\\">.nav{background:var(--primary-color);box-shadow:-1px 1px 1px 0 #0000001a;height:50px;width:100%}.nav,.nav-content{align-items:center;display:flex}.nav-content{justify-content:space-between}.nav-list{align-items:center;display:flex}.nav-li{list-style:none}.nav-li.active .nav-link,.nav-li.active .sidebar-link{font-weight:700}.nav-link{color:#000;font-size:.875rem;line-height:1.25rem;text-decoration:none}.nav-logo{font-size:1.2rem}.nav-logo-img{max-height:40px;max-width:100%}.desktop{display:none}.mobile{display:block}@media (min-width:768px){.desktop{display:block}.mobile{display:none}}.sidebar{background:var(--primary-color);border-top:1px solid rgba(0,0,0,.1);box-shadow:-2px 1px 1px rgba(0,0,0,.1);height:calc(100vh - 51px);max-height:100%;min-width:300px;overflow-y:auto;position:fixed;right:0;top:50px;z-index:1}.sidebar-header{cursor:pointer;padding:15px 15px 0}.sidebar-content{padding:15px}</style>\\n"],"names":[],"mappings":"AA+ImB,gCAAI,CAAC,WAAW,IAAI,eAAe,CAAC,CAAC,WAAW,IAAI,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,SAAS,CAAC,OAAO,IAAI,CAAC,MAAM,IAAI,CAAC,gCAAI,CAAC,wCAAY,CAAC,YAAY,MAAM,CAAC,QAAQ,IAAI,CAAC,wCAAY,CAAC,gBAAgB,aAAa,CAAC,qCAAS,CAAC,YAAY,MAAM,CAAC,QAAQ,IAAI,CAAC,mCAAO,CAAC,WAAW,IAAI,CAAC,OAAO,qBAAO,CAAC,uBAAS,CAAC,OAAO,qBAAO,CAAC,2BAAa,CAAC,YAAY,GAAG,CAAC,qCAAS,CAAC,MAAM,IAAI,CAAC,UAAU,OAAO,CAAC,YAAY,OAAO,CAAC,gBAAgB,IAAI,CAAC,qCAAS,CAAC,UAAU,MAAM,CAAC,yCAAa,CAAC,WAAW,IAAI,CAAC,UAAU,IAAI,CAAC,oCAAQ,CAAC,QAAQ,IAAI,CAAC,mCAAO,CAAC,QAAQ,KAAK,CAAC,MAAM,AAAC,WAAW,KAAK,CAAC,CAAC,oCAAQ,CAAC,QAAQ,KAAK,CAAC,mCAAO,CAAC,QAAQ,IAAI,CAAC,CAAC,oCAAQ,CAAC,WAAW,IAAI,eAAe,CAAC,CAAC,WAAW,GAAG,CAAC,KAAK,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,WAAW,IAAI,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,OAAO,KAAK,KAAK,CAAC,CAAC,CAAC,IAAI,CAAC,CAAC,WAAW,IAAI,CAAC,UAAU,KAAK,CAAC,WAAW,IAAI,CAAC,SAAS,KAAK,CAAC,MAAM,CAAC,CAAC,IAAI,IAAI,CAAC,QAAQ,CAAC,CAAC,2CAAe,CAAC,OAAO,OAAO,CAAC,QAAQ,IAAI,CAAC,IAAI,CAAC,CAAC,CAAC,4CAAgB,CAAC,QAAQ,IAAI,CAAC"}`
};
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="${"nav svelte-fnvt2m"}"><div class="${"container"}"><div class="${"nav-content svelte-fnvt2m"}">${(home == null ? void 0 : home.image) && home.image.length ? `<a class="${"nav-link nav-logo font-semibold svelte-fnvt2m"}" href="${"/"}"><img class="${"nav-logo-img svelte-fnvt2m"}"${add_attribute("src", API_URL + home.image[0].url, 0)}${add_attribute("alt", home.title, 0)}></a>` : `<a class="${"nav-link nav-logo font-semibold svelte-fnvt2m"}" href="${"/"}">${escape(home.title)}</a>`}
			<ul class="${"nav-list svelte-fnvt2m"}">${pages2.length ? `${each(pagesInMenu, (dPage) => `<li class="${[
    "nav-li mr-4 desktop svelte-fnvt2m",
    $page.path === "/" + dPage.url ? "active" : ""
  ].join(" ").trim()}"><a class="${"nav-link svelte-fnvt2m"}" href="${"/" + escape(dPage.url)}">${escape(dPage.title)}</a>
						</li>`)}` : ``}
				${!user2 ? `<li class="${["nav-li mr-4 svelte-fnvt2m", $page.path === "/auth/register" ? "active" : ""].join(" ").trim()}"><a class="${"nav-link svelte-fnvt2m"}" href="${"/auth/register"}">Register</a></li>
					<li class="${["nav-li mr-4 svelte-fnvt2m", $page.path === "/auth/login" ? "active" : ""].join(" ").trim()}"><a class="${"nav-link svelte-fnvt2m"}" href="${"/auth/login"}">Login</a></li>` : ``}
				${user2 ? `<li class="${"nav-li svelte-fnvt2m"}"><a class="${"nav-link svelte-fnvt2m"}" href="${"/"}">Logout</a></li>` : ``}
				${pages2.length ? `<li class="${"nav-li mobile svelte-fnvt2m"}">${validate_component(Dropdown_shell, "DropdownShell").$$render($$result, {}, {}, {
    default: ({ toggle }) => `<button class="${"nav-link mr-4 ml-4 cursor-pointer flex items-center mt-0.5 svelte-fnvt2m"}">Menu ${validate_component(ChevronDownIcon, "ChevronDownIcon").$$render($$result, { size: "1x", class: "ml dropdown-chevron" }, {}, {})}</button>
							${validate_component(Dropdown, "Dropdown").$$render($$result, { right: true }, {}, {
      default: () => `<ul class="${"px-4 py-2"}">${each(pagesInMenu, (dPage) => `<li class="${[
        "nav-li mr-4 svelte-fnvt2m",
        $page.path === "/" + dPage.url ? "active" : ""
      ].join(" ").trim()}"><a class="${"nav-link svelte-fnvt2m"}" href="${"/" + escape(dPage.url)}">${escape(dPage.title)}</a>
										</li>`)}</ul>`
    })}`
  })}</li>` : ``}
				<li class="${"px-4 max-h-6"}"><button><svg fill="${"#000000"}" xmlns="${"http://www.w3.org/2000/svg"}" viewBox="${"0 0 24 24"}" width="${"24px"}" height="${"24px"}"><path d="${"M 2 5 L 2 7 L 22 7 L 22 5 L 2 5 z M 2 11 L 2 13 L 22 13 L 22 11 L 2 11 z M 2 17 L 2 19 L 22 19 L 22 17 L 2 17 z"}"></path></svg></button></li></ul></div></div></nav>
${sidebarOpen ? `<div class="${"flex flex-col sidebar svelte-fnvt2m"}"><div class="${"sidebar-header svelte-fnvt2m"}"><button class="${"text-2xl"}">${validate_component(XIcon, "XIcon").$$render($$result, { size: "1x", class: "text-gray-400" }, {}, {})}</button></div>

		<div class="${"sidebar-content svelte-fnvt2m"}">${categories2.length ? `${validate_component(Accordion, "Accordion").$$render($$result, {}, {}, {
    default: ({ closeOtherPanels }) => `${each(categories2, (category) => `<div class="${"mb-4"}">${validate_component(Accordion_section, "AccordionSection").$$render($$result, {}, {}, {
      handle: ({ toggle }) => `<div slot="${"handle"}">${category.pages.length ? `<button class="${"nav-link mx-auto cursor-pointer flex items-center mt-0.5 svelte-fnvt2m"}"><h3 class="${"text-2xl"}">${escape(category.Title)}</h3>
      ...
      default: ({ toggle }) => `${category.pages.length ? `<div class="${"px-4 py-1"}">${each(category.pages, (cPage) => `<li class="${[
        "nav-li flex items-center my-1 svelte-fnvt2m",
        $page.path === "/" + cPage.url ? "active" : ""
      ].join(" ").trim()}"><a class="${"sidebar-link text-base mx-auto svelte-fnvt2m"}" href="${"/" + escape(cPage.url)}">${escape(cPage.title)}</a>
											</li>`)}
									</div>` : ``}
							`
    })}
...
var U5Bpageu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  title = ((_b = (_a2 = pages.value) == null ? void 0 : _a2.find((p) => p.slug === pageSlug)) == null ? void 0 : _b.metaTitle) || pageSlug;
  $$unsubscribe_errors();
