...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-e40cee9a.js",
      css: [assets + "/_app/assets/start-464e9d0a.css", assets + "/_app/assets/vendor-15e614f1.css"],
      js: [assets + "/_app/start-e40cee9a.js", assets + "/_app/chunks/vendor-d3b32fb2.js", assets + "/_app/chunks/singletons-12a22614.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 418, "type": "image/png" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-4e4f6607.js", "css": ["assets/pages/__layout.svelte-7ad00687.css", "assets/vendor-15e614f1.css"], "js": ["pages/__layout.svelte-4e4f6607.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/store-cf9ac742.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-c05ca9a0.js", "css": ["assets/vendor-15e614f1.css"], "js": ["error.svelte-c05ca9a0.js", "chunks/vendor-d3b32fb2.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-12aa23a1.js", "css": ["assets/vendor-15e614f1.css"], "js": ["pages/index.svelte-12aa23a1.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js"], "styles": [] }, "src/routes/blogs/index.svelte": { "entry": "pages/blogs/index.svelte-09b1e54b.js", "css": ["assets/pages/blogs/index.svelte-144fa14a.css", "assets/vendor-15e614f1.css"], "js": ["pages/blogs/index.svelte-09b1e54b.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js"], "styles": [] }, "src/routes/blogs/[blog].svelte": { "entry": "pages/blogs/[blog].svelte-22533ee8.js", "css": ["assets/pages/blogs/[blog].svelte-b9c23bba.css", "assets/vendor-15e614f1.css"], "js": ["pages/blogs/[blog].svelte-22533ee8.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/store-cf9ac742.js"], "styles": [] }, "src/routes/auth/register.svelte": { "entry": "pages/auth/register.svelte-ebf8d48c.js", "css": ["assets/pages/auth/login.svelte-27d7bfbb.css", "assets/vendor-15e614f1.css", "assets/Form-1a6dab33.css"], "js": ["pages/auth/register.svelte-ebf8d48c.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/Form-637b0377.js", "chunks/store-cf9ac742.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/auth/login.svelte": { "entry": "pages/auth/login.svelte-01046ff2.js", "css": ["assets/pages/auth/login.svelte-27d7bfbb.css", "assets/vendor-15e614f1.css", "assets/Form-1a6dab33.css"], "js": ["pages/auth/login.svelte-01046ff2.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/Form-637b0377.js", "chunks/store-cf9ac742.js", "chunks/navigation-51f4a605.js", "chunks/singletons-12a22614.js"], "styles": [] }, "src/routes/[page]/[subpage].svelte": { "entry": "pages/[page]/[subpage].svelte-a9f1e4d6.js", "css": ["assets/vendor-15e614f1.css", "assets/Form-1a6dab33.css"], "js": ["pages/[page]/[subpage].svelte-a9f1e4d6.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/store-cf9ac742.js", "chunks/Form-637b0377.js"], "styles": [] }, "src/routes/[page].svelte": { "entry": "pages/[page].svelte-6ac4c37b.js", "css": ["assets/vendor-15e614f1.css", "assets/Form-1a6dab33.css"], "js": ["pages/[page].svelte-6ac4c37b.js", "chunks/vendor-d3b32fb2.js", "chunks/api-193a04e1.js", "chunks/store-cf9ac742.js", "chunks/Form-637b0377.js"], "styles": [] } };
...
var css$5 = {
  code: ".nav.svelte-o5frpr.svelte-o5frpr{box-shadow:0 1px 2px 0 rgba(40,42,49,.16);height:50px;width:100%}.nav.svelte-o5frpr.svelte-o5frpr,.nav-content.svelte-o5frpr.svelte-o5frpr{align-items:center;display:flex}.nav-content.svelte-o5frpr.svelte-o5frpr{justify-content:space-between}.nav-list.svelte-o5frpr.svelte-o5frpr{display:flex}.nav-li.svelte-o5frpr.svelte-o5frpr{list-style:none}.nav-li.active.svelte-o5frpr .nav-link.svelte-o5frpr{font-weight:700}.nav-link.svelte-o5frpr.svelte-o5frpr{color:#000;font-size:.875rem;text-decoration:none}.nav-logo.svelte-o5frpr.svelte-o5frpr{font-size:1.2rem}.nav-logo-img.svelte-o5frpr.svelte-o5frpr{max-height:40px;max-width:100%}.desktop.svelte-o5frpr.svelte-o5frpr{display:none}.mobile.svelte-o5frpr.svelte-o5frpr{display:block}@media(min-width:768px){.desktop.svelte-o5frpr.svelte-o5frpr{display:block}.mobile.svelte-o5frpr.svelte-o5frpr{display:none}}",
  map: `{"version":3,"file":"Header.svelte","sources":["Header.svelte"],"sourcesContent":["<script>\\n\\timport { page } from '$app/stores';\\n\\timport { createEventDispatcher } from 'svelte';\\n\\timport { DropdownShell, Dropdown } from 'attractions';\\n\\timport { API_URL } from '../constants';\\n\\texport let user;\\n\\texport let pages = [];\\n\\t$: home = pages.find(p => p.slug === 'home') || {title: 'home'}\\n\\n\\tconst dispatch = createEventDispatcher();\\n\\tconst handleLogout = () => {\\n\\t\\tdispatch('logout');\\n\\t};\\n<\/script>\\n\\n<nav class=\\"nav\\">\\n\\t<div class=\\"container\\">\\n\\t\\t<div class=\\"nav-content\\">\\n\\t\\t\\t{#if home?.image && home.image.length}\\n\\t\\t\\t<a class=\\"nav-link nav-logo font-semibold\\" href=\\"/\\">\\n\\t\\t\\t\\t<img class=\\"nav-logo-img\\" src=\\"{ API_URL + home.image[0].url}\\" alt=\\"{home.title}\\">\\n\\t\\t\\t</a>\\n\\t\\t\\t{:else}\\n\\t\\t\\t<a class=\\"nav-link nav-logo font-semibold\\" href=\\"/\\">{home.title}</a>\\n\\t\\t\\t{/if}\\n\\t\\t\\t<ul class=\\"nav-list\\">\\n\\t\\t\\t\\t{#if pages.length}\\n\\t\\t\\t\\t\\t{#each pages.filter(p => p.slug !== 'home') as dPage}\\n\\t\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4 desktop\\" class:active={$page.path === '/' + dPage.url}>\\n\\t\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/{dPage.url}\\">{dPage.title}</a>\\n\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if !user}\\n\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/auth/register'}>\\n\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/auth/register\\">Register</a>\\n\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/auth/login'}>\\n\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/auth/login\\">Login</a>\\n\\t\\t\\t\\t</li>\\n\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if user}\\n\\t\\t\\t\\t\\t<li class=\\"nav-li\\"><a class=\\"nav-link\\" href=\\"/\\" on:click={handleLogout}>Logout</a></li>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t{#if pages.length}\\n\\t\\t\\t\\t\\t<li class=\\"nav-li mobile\\">\\n\\t\\t\\t\\t\\t\\t<DropdownShell let:toggle>\\n\\t\\t\\t\\t\\t\\t\\t<a href=\\"{'#'}\\"\\n\\t\\t\\t\\t\\t\\t\\t\\tclass=\\"nav-link mr-4  ml-4 cursor-pointer flex items-center mt-0.5\\"\\n\\t\\t\\t\\t\\t\\t\\t\\ton:click={toggle}\\n\\t\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t\\t<span>Menu</span> <span class=\\"-mt-1 ml-1 flex\\">\u2304</span>\\n\\t\\t\\t\\t\\t\\t\\t</a>\\n\\t\\t\\t\\t\\t\\t\\t<Dropdown right>\\n\\t\\t\\t\\t\\t\\t\\t\\t<div class=\\"px-4 py-2\\">\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{#each pages.filter(p => p.slug !== 'home') as dPage}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<li class=\\"nav-li mr-4\\" class:active={$page.path === '/' + dPage.url}>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t<a class=\\"nav-link\\" href=\\"/{dPage.url}\\">{dPage.title}</a>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t\\t\\t</Dropdown>\\n\\t\\t\\t\\t\\t\\t</DropdownShell>\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t</ul>\\n\\t\\t</div>\\n\\t</div>\\n</nav>\\n\\n<style lang=\\"scss\\">.nav{box-shadow:0 1px 2px 0 rgba(40,42,49,.16);height:50px;width:100%}.nav,.nav-content{align-items:center;display:flex}.nav-content{justify-content:space-between}.nav-list{display:flex}.nav-li{list-style:none}.nav-li.active .nav-link{font-weight:700}.nav-link{color:#000;font-size:.875rem;text-decoration:none}.nav-logo{font-size:1.2rem}.nav-logo-img{max-height:40px;max-width:100%}.desktop{display:none}.mobile{display:block}@media (min-width:768px){.desktop{display:block}.mobile{display:none}}</style>\\n"],"names":[],"mappings":"AAsEmB,gCAAI,CAAC,WAAW,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,CAAC,CAAC,KAAK,EAAE,CAAC,EAAE,CAAC,EAAE,CAAC,GAAG,CAAC,CAAC,OAAO,IAAI,CAAC,MAAM,IAAI,CAAC,gCAAI,CAAC,wCAAY,CAAC,YAAY,MAAM,CAAC,QAAQ,IAAI,CAAC,wCAAY,CAAC,gBAAgB,aAAa,CAAC,qCAAS,CAAC,QAAQ,IAAI,CAAC,mCAAO,CAAC,WAAW,IAAI,CAAC,OAAO,qBAAO,CAAC,uBAAS,CAAC,YAAY,GAAG,CAAC,qCAAS,CAAC,MAAM,IAAI,CAAC,UAAU,OAAO,CAAC,gBAAgB,IAAI,CAAC,qCAAS,CAAC,UAAU,MAAM,CAAC,yCAAa,CAAC,WAAW,IAAI,CAAC,UAAU,IAAI,CAAC,oCAAQ,CAAC,QAAQ,IAAI,CAAC,mCAAO,CAAC,QAAQ,KAAK,CAAC,MAAM,AAAC,WAAW,KAAK,CAAC,CAAC,oCAAQ,CAAC,QAAQ,KAAK,CAAC,mCAAO,CAAC,QAAQ,IAAI,CAAC,CAAC"}`
};
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_page();
  return `<nav class="${"nav svelte-o5frpr"}"><div class="${"container"}"><div class="${"nav-content svelte-o5frpr"}">${(home == null ? void 0 : home.image) && home.image.length ? `<a class="${"nav-link nav-logo font-semibold svelte-o5frpr"}" href="${"/"}"><img class="${"nav-logo-img svelte-o5frpr"}"${add_attribute("src", API_URL + home.image[0].url, 0)}${add_attribute("alt", home.title, 0)}></a>` : `<a class="${"nav-link nav-logo font-semibold svelte-o5frpr"}" href="${"/"}">${escape(home.title)}</a>`}
			<ul class="${"nav-list svelte-o5frpr"}">${pages2.length ? `${each(pages2.filter((p) => p.slug !== "home"), (dPage) => `<li class="${[
    "nav-li mr-4 desktop svelte-o5frpr",
    $page.path === "/" + dPage.url ? "active" : ""
  ].join(" ").trim()}"><a class="${"nav-link svelte-o5frpr"}" href="${"/" + escape(dPage.url)}">${escape(dPage.title)}</a>
						</li>`)}` : ``}
				${!user2 ? `<li class="${["nav-li mr-4 svelte-o5frpr", $page.path === "/auth/register" ? "active" : ""].join(" ").trim()}"><a class="${"nav-link svelte-o5frpr"}" href="${"/auth/register"}">Register</a></li>
				<li class="${["nav-li mr-4 svelte-o5frpr", $page.path === "/auth/login" ? "active" : ""].join(" ").trim()}"><a class="${"nav-link svelte-o5frpr"}" href="${"/auth/login"}">Login</a></li>` : ``}
				${user2 ? `<li class="${"nav-li svelte-o5frpr"}"><a class="${"nav-link svelte-o5frpr"}" href="${"/"}">Logout</a></li>` : ``}
				${pages2.length ? `<li class="${"nav-li mobile svelte-o5frpr"}">${validate_component(Dropdown_shell, "DropdownShell").$$render($$result, {}, {}, {
    default: ({ toggle }) => `<a${add_attribute("href", "#", 0)} class="${"nav-link mr-4 ml-4 cursor-pointer flex items-center mt-0.5 svelte-o5frpr"}"><span>Menu</span> <span class="${"-mt-1 ml-1 flex"}">\u2304</span></a>
							${validate_component(Dropdown, "Dropdown").$$render($$result, { right: true }, {}, {
      default: () => `<div class="${"px-4 py-2"}">${each(pages2.filter((p) => p.slug !== "home"), (dPage) => `<li class="${[
        "nav-li mr-4 svelte-o5frpr",
        $page.path === "/" + dPage.url ? "active" : ""
      ].join(" ").trim()}"><a class="${"nav-link svelte-o5frpr"}" href="${"/" + escape(dPage.url)}">${escape(dPage.title)}</a>
										</li>`)}</div>`
    })}`
...
${loaded ? `${validate_component(Header, "Header").$$render($$result, { user: $user, pages: allPages }, {}, {})}
...
<div class="${"container max-w-6xl"}">${blogs ? `${each(blogs.filter((blog) => category ? blog.categories.includes(category) : true), (blog) => `<a class="${"card svelte-1hsgc6a"}" rel="${"prefetch"}" href="${"/blogs/" + escape(blog.slug)}"><div class="${"card-left svelte-1hsgc6a"}"><div class="${"card-left-top"}"><div class="${"thumbnail svelte-1hsgc6a"}"><img class="${"card-left-img svelte-1hsgc6a"}"${add_attribute("alt", blog.slug, 0)}${add_attribute("src", API_URL + blog.Image[0].url, 0)} loading="${"lazy"}">
					</div></div>
				<div class="${"card-left-bottom svelte-1hsgc6a"}"><p class="${"date svelte-1hsgc6a"}">${escape(new Date(blog.created_at).toLocaleDateString())}</p>
				</div></div>

			<div class="${"card-right svelte-1hsgc6a"}"><h2 class="${"svelte-1hsgc6a"}">${escape(blog.Title)}</h2>
				<div class="${"separator svelte-1hsgc6a"}"></div>
				<p class="${"svelte-1hsgc6a"}">${escape(blog.Description)}
				</p></div>
		</a>`)}` : ``}
</div>`;
});
...
<div class="${"container max-w-6xl"}">${blog ? `<h1 class="${"text-center text-4xl mt-8 pb-4"}">${escape(blog.Title)}</h1>
	...
	<span class="${"date svelte-wq3e5t"}">${escape(new Date(blog.created_at).toLocaleDateString())}</span>
...
<div class="${"w-full"}">${content ? `<!-- HTML_TAG_START -->${content}<!-- HTML_TAG_END -->` : ``}
